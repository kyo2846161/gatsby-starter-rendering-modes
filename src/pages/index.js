...
export default function Index() {
  ...
  const intro1_y = useTransform(scrollY, [0, winHeight/2], [0, -winHeight/2]);
  const intro2_margin = useTransform(scrollY, [0, winHeight/2], [0, 10]);
  const intro2_blur = useTransform(scrollY, [0, winHeight/2], [0, 8]);
  ...
  const string_intro2 = "by creating better UX";
    ...
    <>
      {typeof window !== "undefined" ? (
        <>
          ...
          <motion.div style={{y: intro_y, opacity: intro_opacity, height: winHeight, overflow: "hidden", marginTop: -64, display: "flex", alignItems: "center", justifyContent: "center", flexDirection: "column" }}>
